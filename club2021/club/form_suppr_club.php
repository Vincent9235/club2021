...
$req = $pdo->prepare('DELETE FROM clubs WHERE club_id=:num');
$req->bindValue(':num', $_GET['numID'], PDO::PARAM_INT);
$executeIsOK = $req->execute();
if ($executeIsOK) {
   $message = "<div class='txt-center'><div class='success-msg'><i class='fa fa-check'></i> Le club a bien été supprimé</div></div>";
} else {
